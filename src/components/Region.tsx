            ...
            <div className="w-full relative">
                <div className="w-10/12 mx-auto">
                    <svg baseProfile="tiny" fill="#AEAEAE" stroke="#FFF" strokeLinecap="round"
                        ...
                        <path
                            onClick={() => regionStore.setSelectRegion({regionId: 1, areaId: -1})}
                            fill={isRegionSelect(1, regionStore.selectRegion) ? `#F5A659` : ``}
                        ...
                        <path
                            onClick={() => regionStore.setSelectRegion({regionId: 2, areaId: -1})}
                            fill={isRegionSelect(2, regionStore.selectRegion) ? `#B9CD6B` : ``}
                        ...
                        <path
                            onClick={() => regionStore.setSelectRegion({regionId: 3, areaId: -1})}
                            fill={isRegionSelect(3, regionStore.selectRegion) ? `#FDE964` : ``}
                        ...
                        <path
                            onClick={() => regionStore.setSelectRegion({regionId: 4, areaId: -1})}
                            fill={isRegionSelect(4, regionStore.selectRegion) ? `#E49CBC` : ``}
                        ...
                        <path
                            onClick={() => regionStore.setSelectRegion({regionId: 5, areaId: -1})}
                            fill={isRegionSelect(5, regionStore.selectRegion) ? `#89B7E2` : ``}
                        ...
                        <path
                            onClick={() => regionStore.setSelectRegion({regionId: 6, areaId: -1})}
                            fill={isRegionSelect(6, regionStore.selectRegion) ? `#AB90C5` : ``}
                        ...
                        <path
                            onClick={() => regionStore.setSelectRegion({regionId: 7, areaId: -1})}
                            fill={isRegionSelect(7, regionStore.selectRegion) ? `#8EC69A` : ``}
