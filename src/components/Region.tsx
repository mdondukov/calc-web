                ...
                <div className="w-10/12 mx-auto">
                    <svg baseProfile="tiny" fill="#AEAEAE" stroke="#FFF" strokeLinecap="round"
                        ...
                        <path
                            ...
                            fill={!answer || answer.id === 1 ? `#F5A659` : ``}
                        ...
                        <path
                            ...
                            fill={!answer || answer.id === 2 ? `#B9CD6B` : ``}
                        ...
                        <path
                            ...
                            fill={!answer || answer.id === 3 ? `#FDE964` : ``}
                        ...
                        <path
                            onClick={() => {
                                setSelectAnswer(active.id, question.id, 4)
                                setAnswer(fetchAnswer(active.id, question.id, 4))
                            }}
                            fill={!answer || answer.id === 4 ? `#E49CBC` : ``}
                        ...
                        <path
                            onClick={() => {
                                setSelectAnswer(active.id, question.id, 5)
                                setAnswer(fetchAnswer(active.id, question.id, 5))
                            }}
                            fill={!answer || answer.id === 5 ? `#89B7E2` : ``}
                        ...
                        <path
                            onClick={() => {
                                setSelectAnswer(active.id, question.id, 6)
                                setAnswer(fetchAnswer(active.id, question.id, 6))
                            }}
                            fill={!answer || answer.id === 6 ? `#AB90C5` : ``}
                        ...
                        <path
                            onClick={() => {
                                setSelectAnswer(active.id, question.id, 7)
                                setAnswer(fetchAnswer(active.id, question.id, 7))
                            }}
                            fill={!answer || answer.id === 7 ? `#8EC69A` : ``}
