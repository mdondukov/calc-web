...
const getRegion = (id: number): RegionType => {
    let region = regions.find(region => region.id === id)
    return region ? region : {id: 0, name: "", content: ""}
}
...
const Region: React.FC = () => {
    const [region, setRegion] = React.useState<RegionType>({id: 0, name: "", content: ""})

    return (
        <>
            <h1 className="text-4xl text-lime-500 font-bold uppercase mb-12">
                В какой области вы проживаете?
            </h1>
            <div className="w-full relative">
                <div className="w-10/12 mx-auto">
                    <svg baseProfile="tiny" fill="#AEAEAE" stroke="#FFF" strokeLinecap="round"
                        ...
                        <path
                            onClick={() => setRegion(getRegion(1))}
                            fill={region.id === 1 || region.id === 0 ? `#FDE964` : ``}
                        ...
                        <path
                            ...
                            fill={region.id === 1 || region.id === 0 ? `#F5A659` : ``}
                        ...
                        <path
                            onClick={() => setRegion(getRegion(2))}
                            fill={region.id === 2 || region.id === 0 ? `#B9CD6B` : ``}
                        ...
                        <path
                            onClick={() => setRegion(getRegion(3))}
                            fill={region.id === 3 || region.id === 0 ? `#FDE964` : ``}
                        ...
                        <path
                            onClick={() => setRegion(getRegion(4))}
                            fill={region.id === 4 || region.id === 0 ? `#E49CBC` : ``}
                        ...
                        <path
                            onClick={() => setRegion(getRegion(5))}
                            fill={region.id === 5 || region.id === 0 ? `#89B7E2` : ``}
                        ...
                        <path
                            onClick={() => setRegion(getRegion(6))}
                            fill={region.id === 6 || region.id === 0 ? `#AB90C5` : ``}
                        ...
                        <path
                            onClick={() => setRegion(getRegion(7))}
                            fill={region.id === 7 || region.id === 0 ? `#8EC69A` : ``}
                ...
                </div>
                {
                    region.id !== 0 && (
                        <div
                            className={`absolute w-2/5 rounded-xl bg-white/80 p-10 ` + getPosition(region.id)}
                        >
                            <AiOutlineClose
                                size={22}
...
const regions: RegionType[] = [
    {
        ...
        content: "Чуйская область находится в северной части Киргизии, образована как Фрунзенская область 21 ноября 1939 года Указом Президиума Верховного Совета СССР, упразднена в 1959 году. Была восстановлена из районов республиканского подчинения в 1990 году под современным названием."
    },
    {
        id: 2,
        name: "Иссык-Кульская область",
        content: "Иссык-Кульская область самый восточный регион Киргизии. Образована Указом Президиума Верховного Совета СССР от 21 ноября 1939 года с центром в городе Пржевальск (в область был преобразован Иссык-Кульский округ)."
    },
    {
        id: 3,
        name: "Нарынская область",
        content: "Нарынская область находится в центральной части Киргизии. Занимает долины и склоны гор Внутреннего Тянь-Шаня и является самым крупным регионом в стране."
    },
    {
        id: 4,
        name: "Баткенская область",
        content: "Административный центр области — Баткен. На востоке она граничит с Ошской областью, на юге, западе и севере — с Таджикистаном, а на северо-востоке — с Узбекистаном."
    },
    {
        id: 5,
        name: "Жалал-Абадская область",
        content: "Одна из административно-территориальных единиц Кыргызской Республики, расположенная на юго-западе страны. Образована Указом Президиума Верховного Совета СССР от 21 ноября 1939 года. Административный центр области — город Джалал-Абад."
    },
    {
        id: 6,
        name: "Таласская область",
        content: "Таласская область — самая маленькая область Киргизии, находится в северо-западной части страны."
    },
    {
        id: 7,
        name: "Ошская область",
        content: "Ошская область — административная единица Киргизской Республики. Образована Указом Президиума Верховного Совета СССР от 21 ноября 1939 года. Административный центр — город Ош (в состав области не входит)."
    }
]
